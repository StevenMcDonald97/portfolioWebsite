    ...
    return(
      <form id="reused_form" action="" name="contact_form" method="post">
        <div className="modal-body">
            ...
            <div className="form-group">
              <label for="recipient-email" className="col-form-label">Your Email:</label>
              <input type="text" className="form-control" id="recipient-email" name="email" placeholder="john@example.com" required/>
            </div>
            <div className="form-group">
              <label for="message-text" className="col-form-label">Message:</label>
              <textarea className="form-control" id="message-text" name="message" placeholder="Your message..." maxlength="6000" required></textarea>
            </div>
        </div>
